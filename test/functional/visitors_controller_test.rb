...
class VisitorsControllerTest < ActionController::TestCase
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post :create, visitor: { email: @visitor.email, fname: @visitor.fname, language: @visitor.language, lname: @visitor.lname, phone: @visitor.phone }
    end
  ...
  test "should update visitor" do
    put :update, id: @visitor, visitor: { email: @visitor.email, fname: @visitor.fname, language: @visitor.language, lname: @visitor.lname, phone: @visitor.phone }
    assert_redirected_to visitor_path(assigns(:visitor))
  end
